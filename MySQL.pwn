...
#include <zcmd> //ZeeX                                                          Version 0.3.1	https://github.com/YashasSamaga/I-ZCMD	- (Note: Rename izcmd to zcmd and done).
...
CMD:changepassword(playerid, params[])
{
	...
	if (sscanf(params, "s["#MAX_LENGTH_PASSWORD"]", password)) return SendClientMessage(playerid, -1, "* USAGE: /changepassword <new password>");
